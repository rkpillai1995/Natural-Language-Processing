...
parent(averyWhite,violaWhite).
parent(dencyPhillips,violaWhite).
parent(averyWhite,doraWhite).
parent(dencyPhillips,doraWhite).
parent(averyWhite,bessieWhite).
parent(dencyPhillips,bessieWhite).
parent(doraWhite,alfredWhiteson). 
parent(williamWrightson, alfredWhiteson).
...
parent(amosAdams, miltonAdams).
parent(betsyGriggs, miltonAdams).
parent(leviAdams, amosAdams).
parent(hannahHeald, amosAdams).
parent(johnAdams2, leviAdams).
parent(joannaMunroe, leviAdams).
parent(thomasAdams, johnAdams2).
parent(josephAdams, thomasAdams).
parent(johnAdams1, josephAdams).
parent(henryAdams, johnAdams1).
parent(annaHowe, josephAdams).
parent(lydiaChadwick, johnAdams).
parent(rebeccaCutter, thomasAdams).
parent(ltJonasMunroe,joannaMunroe).
parent(johnMunroe, ltJonasMunroe).
parent(williamMunroe, johnMunroe).
parent(hoseaPhillips2,dencyPhillips).
parent(hoseaPhillips1, hoseaPhillips2).
parent(johnPhillips, hoseaPhillips1).
parent(dimmisAylesworth, johnPhillips).
parent(maryFranklin,dimmisAylesworth).
parent(jamesFranklin1, maryFranklin).
parent(jamesFranklin1, jamesFranklin2).
parent(jamesFranklin2, elishaFranklin).
parent(elishaFranklin, johnFranklin).
parent(johnFranklin, anthonyFranklin).
parent(anthonyFranklin, esekFranklin).
parent(esekFranklin, oscaraFranklin).
parent(arthurAylesworth, dimmisAylesworth).
...
female(joanBeaufort).
female(joannaMunroe).
female(dimmisAylesworth).
female(betsyGriggs).
female(hannahHeald).
female(rebeccaCutter).
female(annaHowe).
female(maryFranklin).
female(violaWhite).
female(doraWhite).
...
male(johnFranklin).
male(elishaFranklin).
male(anthonyFranklin).
male(esekFranklin). 
male(arthurAylesworth).
male(alfredWhiteson).
male(williamWrightson).
